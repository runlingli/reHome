...
enum MockData {
    ...
    static let users: [String: SellerProfile] = [
        "u_emma":  .init(id: "u_emma",  name: "Emma L.",  handle: "@emma.l",   school: "Boston University",
        ...
        "u_jin":   .init(id: "u_jin",   name: "Jin C.",   handle: "@jin.chen", school: "Harvard University",
        ...
        "u_dani":  .init(id: "u_dani",  name: "Dani O.",  handle: "@dani.o",   school: "MIT",
        ...
        "u_lucas": .init(id: "u_lucas", name: "Lucas M.", handle: "@lucasm",   school: "Northeastern",
        ...
        "me_student": .init(id: "me_student", name: "You", handle: "@you.edu", school: "Boston University",
    ...
    static let listings: [Listing] = [
        .init(id: "i1",  title: "IKEA Malm desk · white",        category: "furniture", condition: .excellent, estValue: 149, age: "14 mo", pickup: "Mid-May",
              desc: "Compact desk, fits a 27\" monitor. Two screw holes near the back from a monitor mount. Pickup only — 4th-floor walk-up.",
              sellerHandle: "u_emma", location: "Allston, MA",
        ...
        .init(id: "i2",  title: "Cuisinart 4-cup coffee maker",   category: "appliance", condition: .good, estValue: 38, age: "2 yr", pickup: "May 18 – 22",
              desc: "Works perfectly, just descaled. Comes with a permanent gold filter, no paper needed.",
              sellerHandle: "u_jin", location: "Cambridge, MA",
        ...
        .init(id: "i3",  title: "Trek FX 2 hybrid bike",          category: "bike",      condition: .good, estValue: 420, age: "3 yr", pickup: "After May 20",
              desc: "Size M. Recently tuned at Cambridge Bicycle. Includes lock and front light. One small scratch on the top tube.",
              sellerHandle: "u_dani", location: "Somerville, MA",
        ...
        .init(id: "i4",  title: "Twin XL mattress + frame",       category: "furniture", condition: .good, estValue: 220, age: "10 mo", pickup: "May 25 – 30",
        ...
        .init(id: "i6",  title: "Lodge cast-iron skillet · 10\"", category: "kitchen",   condition: .good, estValue: 30, age: "2 yr", pickup: "Mid-May",
              desc: "Well-seasoned. Becomes nonstick with a thin coat of oil.",
              sellerHandle: "u_lucas", location: "Brookline, MA",
        ...
        .init(id: "i7",  title: "Uniqlo down jacket · M",         category: "clothing",  condition: .excellent, estValue: 70, age: "8 mo", pickup: "Mid-May",
        ...
        .init(id: "i8",  title: "Air fryer · Cosori 5.8 qt",      category: "appliance", condition: .excellent, estValue: 90, age: "1 yr", pickup: "May 20 – 25",
        ...
        .init(id: "i9",  title: "Bookshelf, 3-tier · oak",        category: "furniture", condition: .fair, estValue: 80, age: "4 yr", pickup: "Before May 25",
        ...
        .init(id: "i10", title: "Ceramic dinner set · 4 pcs",     category: "kitchen",   condition: .excellent, estValue: 45, age: "1 yr", pickup: "Mid-May",
        ...
        .init(id: "i12", title: "Office chair · Steelcase Series 1", category: "furniture", condition: .excellent, estValue: 380, age: "18 mo", pickup: "Late May",
